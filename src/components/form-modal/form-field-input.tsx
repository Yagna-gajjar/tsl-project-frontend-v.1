    ...
    <div ref={containerRef} className="relative w-full">
      <div
        ...
        className={`flex items-center justify-between gap-2 p-2 border rounded-md bg-background cursor-pointer transition-all ${isOpen ? "ring-2 ring-ring border-primary" : "border-input"
            ...
            : "hover:border-accent-foreground/30 focus:outline-none focus:ring-2 focus:ring-ring"
          }`}
      >
          ...
          {selectedValues.length > 0 ? (
            selectedValues.map((val) => {
              ...
              return (
                <span
                  key={String(val)}
                  className={`${!isSingle ? `bg-primary/10 text-primary text-xs border border-primary/20` : `text-sm`
      ...
      {isOpen && (
        <div
          ...
          className="absolute top-full w-full shadow-md z-[100] mt-1 bg-popover border border-border rounded-md overflow-hidden animate-in fade-in zoom-in-95 duration-100"
        >
