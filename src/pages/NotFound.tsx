...
export default function PageNotFound() {
  ...
  return (
    <div className="min-h-[80vh] bg-gradient-to-br from-background via-background to-muted/20 flex items-center justify-center relative overflow-hidden">
      ...
      <div
        className={`fixed w-6 h-6 bg-primary/30 rounded-full pointer-events-none z-50 transition-opacity duration-200 ${
      ...
      <div className="text-center z-20 relative">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-foreground">
            Oops! Page Under Constuction
          </h2>
          <p className="text-lg text-muted-foreground max-w-md mx-auto">
            The page you're looking for seems to have wandered off the TSL site.
            Our crew is working hard to build it!
          </p>
        </motion.div>
